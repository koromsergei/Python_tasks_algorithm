...
def transmittion(y):
    ...
    return y_t
file = r"C:\Users\lysikova.dv\Documents\GitHub\Python_tasks_algorithm\spc_master_test\Rhodamine 30.11\Spectrum_(LS6)-2021_11_30-ID_42.spc"
...
plt.plot (x, transmittion(y), label = 'исходный спектр')
