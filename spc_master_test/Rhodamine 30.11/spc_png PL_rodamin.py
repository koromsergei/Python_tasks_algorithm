...
"""
file = r"C:\Users\lysikova.dv\Documents\GitHub\Python_tasks_algorithm\spc_master_test\Rhodamine 30.11\Spectrum_(LS6)-2021_11_30-ID_49.spc"
[x1, y1] = get_spectra (file)  # исходный спектр
q1 = min(y1)
...
[x, y] = get_spectra (file)  #положили родамин
