...
file = "F:\ITMO UNIVERSITY\CRYSTAL LAB\Полезные программы\spc_master_test\Spectrum_(LS6)-2021_05_04-ID_63.spc"
[x,y] = get_spectra (file)
plt.plot (x,(y-y2)/(y1-y2))# конечный спектр

file = "F:\ITMO UNIVERSITY\CRYSTAL LAB\Полезные программы\spc_master_test\Spectrum_(LS6)-2021_05_04-ID_64.spc"
[x,y] = get_spectra (file)
plt.plot (x,(y-y2)/(y1-y2))# конечный спектр

file = "F:\ITMO UNIVERSITY\CRYSTAL LAB\Полезные программы\spc_master_test\Spectrum_(LS6)-2021_05_04-ID_65.spc"
[x,y] = get_spectra (file)
plt.plot (x,(y-y2)/(y1-y2))# конечный спектр

file = "F:\ITMO UNIVERSITY\CRYSTAL LAB\Полезные программы\spc_master_test\Spectrum_(LS6)-2021_05_04-ID_66.spc"
[x,y] = get_spectra (file)
plt.plot (x,(y-y2)/(y1-y2))# конечный спектр

file = "F:\ITMO UNIVERSITY\CRYSTAL LAB\Полезные программы\spc_master_test\Spectrum_(LS6)-2021_05_04-ID_67.spc"
[x,y] = get_spectra (file)
plt.plot (x,(y-y2)/(y1-y2))# конечный спектр
