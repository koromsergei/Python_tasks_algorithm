...
test_level_enemy_list = [Enemy(copy(FIRST_ENEMY_POSITION), FIRST_ENEMY_SIZE)]
...
second_level_enemy_list = [Enemy(copy(FIRST_SECOND_LEVEL_ENEMY_POSITION), FIRST_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(SECOND_SECOND_LEVEL_ENEMY_POSITION), SECOND_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(THIRD_SECOND_LEVEL_ENEMY_POSITION), THIRD_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(FOURTH_SECOND_LEVEL_ENEMY_POSITION), FOURTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(FIFTH_SECOND_LEVEL_ENEMY_POSITION), FIFTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(SIXTH_SECOND_LEVEL_ENEMY_POSITION), SIXTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(SEVENTH_SECOND_LEVEL_ENEMY_POSITION), SEVENTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(EIGHTH_SECOND_LEVEL_ENEMY_POSITION), EIGHTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(NINTH_SECOND_LEVEL_ENEMY_POSITION), NINTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(TENTH_SECOND_LEVEL_ENEMY_POSITION), TENTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(ELEVENTH_SECOND_LEVEL_ENEMY_POSITION), ELEVENTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(TWELFTH_SECOND_LEVEL_ENEMY_POSITION), TWELFTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(THIRTEENTH_SECOND_LEVEL_ENEMY_POSITION), THIRTEENTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(FOURTEENTH_SECOND_LEVEL_ENEMY_POSITION), FOURTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(FIFTEENTH_SECOND_LEVEL_ENEMY_POSITION), FIFTEENTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(SIXTEENTH_SECOND_LEVEL_ENEMY_POSITION), SIXTEENTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(SEVENTEENTH_SECOND_LEVEL_ENEMY_POSITION), SEVENTEENTH_SECOND_LEVEL_ENEMY_SIZE),
                           Enemy(copy(EIGHTEENTH_SECOND_LEVEL_ENEMY_POSITION), EIGHTEENTH_SECOND_LEVEL_ENEMY_SIZE)
                           ]
...
third_level_enemy_list = [Enemy(copy(FIRST_THIRD_LEVEL_ENEMY_POSITION), FIRST_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(SECOND_THIRD_LEVEL_ENEMY_POSITION), SECOND_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(THIRD_THIRD_LEVEL_ENEMY_POSITION), THIRD_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(FOURTH_THIRD_LEVEL_ENEMY_POSITION), FOURTH_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(FIFTH_THIRD_LEVEL_ENEMY_POSITION), FIFTH_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(SIXTH_THIRD_LEVEL_ENEMY_POSITION), SIXTH_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(SEVENTH_THIRD_LEVEL_ENEMY_POSITION), SEVENTH_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(EIGHTH_THIRD_LEVEL_ENEMY_POSITION), EIGHTH_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(NINTH_THIRD_LEVEL_ENEMY_POSITION), NINTH_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(TENTH_THIRD_LEVEL_ENEMY_POSITION), TENTH_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(ELEVENTH_THIRD_LEVEL_ENEMY_POSITION), ELEVENTH_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(TWELFTH_THIRD_LEVEL_ENEMY_POSITION), TWELFTH_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(THIRTEENTH_THIRD_LEVEL_ENEMY_POSITION), THIRTEENTH_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(FOURTEENTH_THIRD_LEVEL_ENEMY_POSITION), FOURTEENTH_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(FIFTEENTH_THIRD_LEVEL_ENEMY_POSITION), FIFTEENTH_THIRD_LEVEL_ENEMY_SIZE),
                          Enemy(copy(SIXTEENTH_THIRD_LEVEL_ENEMY_POSITION), SIXTEENTH_THIRD_LEVEL_ENEMY_SIZE)
                          ]
third_level_text_dict = {}
third_level_trigger_list = [Trigger(FIRST_THIRD_LEVEL_INVISIBLE_PLATFORM_ENEMY_POSITION,
